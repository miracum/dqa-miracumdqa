...
-   updated tic.r
    ([aad3d2c](https://gitlab.miracum.org/miracum/dqa/miracumdqa.git/tree/aad3d2c99e357e402b463dd763194196445c0e6f))
-   updated remotes section in description to address gha issues
    ([c74fd4d](https://gitlab.miracum.org/miracum/dqa/miracumdqa.git/tree/c74fd4df33c5486a2e2710571adad0839f2c70c9))
...
-   updated newsmd
    ([fed8e4d](https://gitlab.miracum.org/miracum/dqa/miracumdqa.git/tree/fed8e4dc26300978937c029d5c46cd94475e0390))
...
Full set of changes:
[`v3.1.0...fed8e4d`](https://gitlab.miracum.org/miracum/dqa/miracumdqa.git/compare/v3.1.0...fed8e4d)
