...
title: "Überprüfung der ETL-Strecken zwischen Quellsystem (`r rv$source$system_name`) und Zielsystem (`r rv$target$system_name`)"
# subtitle: "Betrachteter Zeitraum: `r DQAstats:::get_restricting_date_info(restricting_date = rv$restricting_date, lang = 'de')`"
author: "Datenqualitätsanalyse des §21-Datensatzes  \nStandort: `r rv$sitename` \n `r DQAstats:::get_restricting_date_info(restricting_date = rv$restricting_date, lang = 'de')`"
date: \today
...
```{r results='asis'}
render_results(rv$results_descriptive, rv$conformance$value_conformance)
```
...
```{r results='asis'}
# plausi results
render_atemp_plausis(rv$results_plausibility_atemporal, rv$conformance$value_conformance)
```
