...
# read mdr
mdr <-
  DQAstats::read_mdr(utils_path = "inst/application/_utilities/")
mdr[, plausibility_relation := NA]

# Geburtsjahr
p <- jsonlite::toJSON(list("uniqueness" = list(
  "patient_birthDate" = list("name" = "Pl.uniqueness.Item01",
...
p <- jsonlite::toJSON(list("uniqueness" = list(
  "patient_identifier_value" = list("name" = "Pl.uniqueness.Item02",
...
p <- jsonlite::toJSON(list("uniqueness" = list(
  "encounter_diagnosis_rank" = list(
    "name" = "Pl.uniqueness.Item03",
